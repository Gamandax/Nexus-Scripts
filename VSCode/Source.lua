...
local codeBox = script:FindFirstChild("CodeBox") and require(script.CodeBox) or loadstring(game:HttpGet("https://raw.githubusercontent.com/Gamandax/Nexus-Scripts/refs/heads/main/VSCode/CodeBox.lua"))()
